            ...
            [
                {
                    ...
                    "Max Points": 40,
                    "How it helps": "Bigger discount versus Marketcheck market value; if market value is missing, cheaper vehicles rank better within that model.",
                },
                {
                    "Factor": "Mileage",
                    "Max Points": 20,
...
def main() -> None:
    ...
    st.title("Sister SUV Search: Reliable, Good Gas Mileage — v5")
    st.write(
